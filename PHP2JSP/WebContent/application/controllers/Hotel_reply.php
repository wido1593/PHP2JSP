<?
    class Hotel_reply extends CI_Controller {
        function __construct() 
        {
            parent::__construct();
            $this->load->database();
            $this->load->model("hotel_reply_m");
		...
		if ( $this->form_validation->run()==TRUE )
		{
         ...
         $data=array(
				...
				'hotel_reply' => $this->input->post("hotel_message",true),
				'hotel_score' => $this->input->post("hotel_score",true),
				'hotel_id' => $this->input->post("hotel_id",true)	
			 );

         $result=$this->hotel_reply_m->insertrow($data); 
