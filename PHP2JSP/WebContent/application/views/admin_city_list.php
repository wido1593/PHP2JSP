...
<script>
    function find_text()
    {
        ...
        form1.action="/~team5/admin_city/lists";
		else		// 값이 있는 경우, text1 값 전달
        form1.action="/~team5/admin_city/lists/text1/" + form1.text1.value;
		form1.submit();
    }
</script>
...
?>
   <!------- <div class="col-8" align="right">           
             <a href="/~team5/admin_city/add<?=$tmp;?>" class="btn btn-sm mycolor1">추가</a>
				</div>
			 </div>
	---->
</form>
                ...
                <div class="x_panel">
                  <div class="x_title">
                    <h2>도시 테이블 <small></small></h2>
                    <ul class="nav navbar-right panel_toolbox">
                      <li><a class="collapse-link"><i class="fa fa-chevron-up"></i></a>
                      </li>
                      
                      <li><a href="/~team5/admin_city/add<?=$tmp;?>">추가</a>
                      </li>
                    </ul>
...
<tr>
    <td><?=$no; ?></td>
    <td><a href="/~team5/admin_city/view/no/<?=$no ?><?=$tmp;?>"><?=$row->name; ?></a></td>
