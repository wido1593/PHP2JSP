                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
					...
					name="form1" method="post" action="">
					  ...
					  <div class="form-group">
                        <label class="control-label col-md-3 col-sm-3 col-xs-12" for="first-name">영어 이름 <span class="required">*</span>
                        </label>
                        <div class="col-md-6 col-sm-6 col-xs-12">
                          <input type="text" name="english_name" value="<?=$row->english_name;?>" required="required" class="form-control col-md-7 col-xs-12">
                        </div>
                      </div>
