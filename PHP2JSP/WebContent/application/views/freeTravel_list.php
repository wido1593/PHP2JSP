...
?>
 ...
 <div class="hero-wrap js-fullheight" style="background-image: url('/~team5/my/images/freetravel.jpg');">
    ...
    function find_text()
    {
        ...
        form1.action="/~team5/freeTravel/lists";
		else		// 값이 있는 경우, text1 값 전달
        form1.action="/~team5/freeTravel/lists/text1/" + form1.text1.value + "/text2/" + form1.text2.value + "/text3/" + form1.text3.value + "/list";
		form1.submit();
    }
...
?> 
		  <div class="strip_all_tour_list wow fadeIn" data-wow-delay="0.1s">
						<div class="row">
							<div class="col-lg-4 col-md-4">
								...
								<div class="img_list">
									<a href="/~team5/freeTravel/view/no/<?=$no ?><?=$tmp;?>"><img src="/~team5/img/<?=$row->pic1?>" alt="Image">
									</a>
								</div>
							</div>
	...
	?>
									...
									<h3><a href="/~team5/freeTravel/view/no/<?=$no ?><?=$tmp;?>"><font color="black"><?=$row->name?></font></a></h3>
									<p><?=$row->intro?></p><br>
							...
							<div class="col-lg-2 col-md-2">
								<div class="price_list">
									...
									<div><sup></sup><font size="2">비행기 최저가</font><?=  number_format($row->flight_min_price);?>원<span class="normal_price_list"></span><small>*1인기준</small>
										...
										<p><a href="/~team5/freeTravel/view/no/<?=$no ?><?=$tmp;?>" class="btn_1">보기</a>
										</p>
									</div>
