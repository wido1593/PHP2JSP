...
<? foreach($row as $row2){}?>
		<div class="container margin_60">
						...
						<tbody>
							<tr>
								<td>
										...
										<img src="/~team5/img/<?=$row2->pic1?>" height="50" width="60">
			...
			<form name="form1" method="post">
					<table class="table table-striped options_cart">
						...
						<tbody>
							<tr>
								...
								<td style="width:60%">
									 로밍 서비스 <strong>+39,000 원</strong>
								</td>
								<td style="width:35%">
									<label class="switch-light switch-ios float-right">
									<input type="checkbox" name="option_1" id="option_1" value="39000" onChange="count1(this);" checked>
										<span>
                    					<span>해제</span>
										<span>선택</span>
										</span>
							...
							<tr>
								...
								<td>
									현지 바이크 투어 <strong>+79,000 원</strong>
								</td>
								<td>
									<label class="switch-light switch-ios float-right">
				...
				<form name="form2" method="post" action="/~team5/product/pay">
						...
						<table class="table table_summary">
							...
							<tr>
								...
								<tr>
									...
									<td class="text-right">
										<input type="text" name="totals" value="61,000" style="border:0; color:#000; text-align: right;" readonly>
									</td>
								</tr>
								<tr class="total">
									<td>
									...
									<? $totalPrice= $totalPrice + 61000;?> 									<td class="text-right">
