<?
    class Admin_findhotel_m extends CI_Model
    {
        public function getlist($text1,$start,$limit)
        {
         if (!$text1)
        $sql="select * from hotel order by name limit $start,$limit";    // 전체 자료
		else
        $sql="select * from hotel where name like '%$text1%' order by name limit $start,$limit";
