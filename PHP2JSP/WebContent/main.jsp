	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<div class="modal-header">
				<div class="avatar">
					<img src="my/images/avatar.jpg" alt="Avatar">
				</div>				
...
<script>
    function find_text()
    {
		if (form1.text1.value == 1)
			form1.action="../../country/lists/text1/" + form1.text2.value;
		else if (form1.text1.value == 2)	
			form1.action="../../product/lists/text1/" + form1.text2.value +"/text2/100000/text3/5000000/list";
		else if (form1.text1.value == 3)	
			form1.action="../../freeTravel/lists/text1/" + form1.text2.value +"/text2/100000/text3/5000000/list";
		else if (form1.text1.value == 4)	
			form1.action="../../hotel/lists/text1/" + form1.text2.value +"/text2/100000/text3/1000000/list";
		form1.submit();
    }
</script>
    <div class="hero-wrap js-fullheight" style="background-image: url('../../my/images/bg_1.jpg');">
        ...
        <div class="row no-gutters slider-text js-fullheight align-items-center justify-content-start" data-scrollax-parent="true">
          <div class="col-md-9 ftco-animate" data-scrollax=" properties: { translateY: '70%' }">
            ...
            <p class="browse d-md-flex">
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="../../country"><i class="fas fa-globe-americas"></i>국가</a></span>
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="../../product"><i class="fas fa-briefcase"></i>패키지</a></span> 
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="../../../FreeTravel"><i class="fa fa-map-marker-alt"></i>자유여행</a></span> 
            	<span class="d-flex justify-content-md-center align-items-md-center"><a href="../../hotel"><i class="fa fa-hotel"></i>호텔</a></span> 
            </p>
          </div>
        </div>
      </div>
...
?>
	    				<div class="item">
		    				<div class="destination">
		    					<a href="../../country/view/no/<?=$no ?><?=$tmp;?>" class="img d-flex justify-content-center align-items-center" style="background-image: url(../../img/<?=$row->pic1?>);">
...
?>			
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					<a href="../../product/view/no/<?=$no ?><?=$tmp;?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(../../img/<?=$row->pic1?>);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="../../product/view/no/<?=$no ?><?=$tmp;?>"><?=$row->name?></a></h3>
		    						<?
	...
	?>
    						...
    						<p class="bottom-area d-flex">
    							...
    							<span class="ml-auto"><a href="../../product/view/no/<?=$no ?><?=$tmp;?>">보기</a></span>
    						</p>
    					</div>
    				</div>
    			</div>
...
?>
    ...
    <section class="ftco-section ftco-counter img" id="section-counter" style="background-image: url(../../my/images/bg_1.jpg);">
    	<div class="container">
...
?>			
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					<a href="../../freeTravel/view/no/<?=$no ?><?=$tmp;?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(../../img/<?=$row->pic1?>);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="../../freeTravel/view/no/<?=$no ?><?=$tmp;?>"><?=$row->name?></a></h3>
		    						<?
										if($row->recommend_no == 1)
										{
											echo ("<p class='rate'>
	...
	?>
    						...
    						<p class="bottom-area d-flex">
    							...
    							<span><i class="icon-map-o"></i> <?=$row->country_name?>, <?=$row->city_name?></span> 
    							<span class="ml-auto"><a href="../../freeTravel/view/no/<?=$no ?><?=$tmp;?>">보기</a></span>
    						</p>
    					</div>
    				</div>
    			</div>
...
?>			
    			<div class="col-sm col-md-6 col-lg ftco-animate">
    				<div class="destination">
    					<a href="../../hotel/view/no/<?=$no ?><?=$tmp;?>" class="img img-2 d-flex justify-content-center align-items-center" style="background-image: url(../../img/<?=$row->img?>);">
    						<div class="icon d-flex justify-content-center align-items-center">
    							<span class="icon-search2"></span>
    						</div>
    					</a>
    					<div class="text p-3">
    						<div class="d-flex">
    							<div class="one">
		    						<h3><a href="../../hotel/view/no/<?=$no ?><?=$tmp;?>"><?=$row->name?></a></h3>
		    						<?
										if($row->score == 1)
										{
											echo ("<p class='rate'>
	...
	?>
    						...
    						<p class="bottom-area d-flex">
    							...
    							<span><i class="icon-map-o"></i> <?=$row->country_name?>, <?=$row->city_name?></span> 
    							<span class="ml-auto"><a href="../../hotel/view/no/<?=$no ?><?=$tmp;?>">보기</a></span>
    						</p>
    					</div>
    				</div>
    			</div>
